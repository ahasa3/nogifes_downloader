...
#reward_movie_02937
download_path = f"{base_dir}/Downloads/movie-card"
...
for id_file in range(start, end+1):
    ...
    filename = f"movie_card_{video_id}.usme"
    link = f'{MAIN_PATH}{OPTIONAL_PATH["movie-card"]}{filename}'
    ...
    movie_card(filename[:-5], download_path)
    os.remove(path_raw)
